...
struct PieCharView: View {
    var dataSet: [DataPoints] = [
        PetDataSet.dublin.reduce(into: DataPoints()) {
        $0.add(value: $1.value, label: $1.name, color: $1.color)
    },
        PetDataSet.milan.reduce(into: DataPoints()) {
        $0.add(value: $1.value, label: $1.name, color: $1.color)
    },
        PetDataSet.london.reduce(into: DataPoints()) {
        $0.add(value: $1.value, label: $1.name, color: $1.color)
    },
    ]
...
struct PieCharView_Previews: PreviewProvider {
